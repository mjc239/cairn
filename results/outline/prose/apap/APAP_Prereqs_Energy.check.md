...
Lean (full): `∀ {G : Type u_1} [inst : AddCommGroup G] [inst_1 : DecidableEq G] [inst_2 : Fintype G] [inst_3 : MeasurableSpace G] [inst_4 : DiscreteMeasurableSpace G] (n : ℕ) (s : Finset G), cLpNorm (α := AddChar G ℂ) (↑((2 : ℕ) * n)) (dft ((↑s).indicator fun x => (1 : ℂ))) ^ ((2 : ℕ) * n) = boringEnergy n s`
...
Lean (full): `∀ {G : Type u_1} [inst : AddCommGroup G] [inst_1 : Fintype G] [inst_2 : MeasurableSpace G] [inst_3 : DiscreteMeasurableSpace G] (s : Finset G), cLpNorm (α := AddChar G ℂ) (2 : ENNReal) (dft ((↑s).indicator fun x => (1 : ℂ))) = √↑s.card`
