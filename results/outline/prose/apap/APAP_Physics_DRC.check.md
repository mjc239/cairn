...
English: For $p \in \mathbb{R}_{\ge 0}$, $\varepsilon \in \mathbb{R}$ and finite sets $B_1, B_2, A \subseteq G$, $s(p,\varepsilon,B_1,B_2,A)$ is a finite subset of $G$ built from these data; it is the set appearing in the sifting lemmas.
