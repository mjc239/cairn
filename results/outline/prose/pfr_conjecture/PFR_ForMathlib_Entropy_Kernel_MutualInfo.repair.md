...
Previous English: Let $\kappa$ be a kernel from $T$ into $S \times U$ that has almost everywhere finite kernel support with respect to the measure $\mu$. Then $0 \le I_k[\kappa,\mu]$.
Checker's issue: The English drops the hypotheses that mu is a finite measure with finite support and that T is countable (with measurable singletons on S, U, T).
