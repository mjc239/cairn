...
Checker's issue: Symbols $\mathfrak T(u)$ (t.𝔗 u), $\mathcal L(\cdot)$ (Forest.𝓛) and $\mathcal Q(u)$ (𝒬 u) are used without being introduced.
...
Checker's issue: Symbols $\mathfrak T(u)$ (t.𝔗 u), $\mathcal L(\cdot)$ (Forest.𝓛) and $\mathcal Q(u)$ (𝒬 u) are used without being introduced. Also $\sigma(u,x)$ and 'kernel pieces' $K_i$ are only vaguely glossed.
