...
## Chapter (Lean module `Carleson.Forest`)

### `TileStructure.Forest` (definition)
Lean: `(X : Type u_1) (n : ℕ) : Type u_1`
Docstring: An `n`-forest

### `TileStructure.Row` (definition)
Lean: `(X : Type u_1) (n : ℕ) : Type u_1`
Docstring: An `n`-row

### `TileStructure.Forest.𝔗` (definition)
Lean: `(self : Forest X n) (_ : 𝔓 X) : Set (𝔓 X)`
