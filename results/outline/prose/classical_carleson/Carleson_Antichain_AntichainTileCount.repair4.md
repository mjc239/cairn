...
Checker's issue: The English asserts that 𝓛' 𝔄 ϑ N consists of the maximal elements (for ≤) of 𝓛 𝔄 ϑ N; nothing in the prompt (docstring 'The set 𝓛* defined in Lemma 6.3.4', no definition body) supports this description.
