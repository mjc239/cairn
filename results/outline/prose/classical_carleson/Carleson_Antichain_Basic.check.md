...
Lean (full): `∀ {X : Type u_1} {a : ℕ} {q : ℝ} {K : X → X → ℂ} {σ₁ σ₂ : X → ℤ} {F G : Set X} [inst : MetricSpace X] [inst_1 : ProofData a q K σ₁ σ₂ F G] [inst_2 : TileStructure Q (defaultD a) (defaultκ a) (defaultS X) (cancelPt X)] (𝔄 : Set (𝔓 X)) {f : X → ℂ}, MemLp f (2 : ENNReal) volume → eLpNorm (Lemma6_1_3.𝓜p 𝔄 (Lemma6_1_3.p X) f) (2 : ENNReal) volume ≤ ↑(C2_0_6 (↑(defaultA a)) (Lemma6_1_3.p X).toNNReal (2 : NNReal)) * eLpNorm f (2 : ENNReal) volume`
