...
Previous English: (Lemma 6.1.6.) Let $\mathfrak{A} \subseteq \mathfrak{P}(X)$ be an antichain with respect to $\le$ and let $\vartheta$ lie in the range of $Q$. Write $p_6 = p_6(a)$ and $D$ = `defaultD a`. Then
...
Previous English: (Lemma 6.3.4.) Let $\mathfrak{A} \subseteq \mathfrak{P}(X)$ be an antichain with respect to $\le$, let $\vartheta$ lie in the range of $Q$, and let $N \in \mathbb{N}$. Then
...
Previous English: If $L \in \mathcal{L}^*(\mathfrak{A}, \vartheta, N)$, then there is a cube $L'$ with $L \le L'$ and $s(L') = s(L) + 1$.
Checker's issue: Omits the standing assumptions ProofData a q K σ₁ σ₂ F G and TileStructure (metric space X, doubling measure, tile structure).
...
Previous English: (Lemma 6.3.2.) For every set of tiles $\mathfrak{A}$, every $\vartheta \in \Theta(X)$, every $N \in \mathbb{N}$ and every cube $L$,
...
Previous English: (Lemma 6.3.1.) Let $p, p'$ be tiles with $d_{\mathfrak{c}(p),\, D^{s(p)}/4}(\mathcal{Q}(p), \vartheta) \le 2^N$ and $d_{\mathfrak{c}(p'),\, D^{s(p')}/4}(\mathcal{Q}(p'), \vartheta) \le 2^N$, where $D$ = `defaultD a`, and suppose $I(p) \le I(p')$ and $s(p) < s(p')$. Then $2^{N+2} p \le 2^{N+2} p'$ (as dilated tiles, via `smul`).
Checker's issue: Omits the standing assumptions ProofData a q K σ₁ σ₂ F G and TileStructure (metric space X, doubling measure, tile structure).
